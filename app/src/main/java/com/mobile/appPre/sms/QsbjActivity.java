...
public class QsbjActivity extends Activity {
	...
	private String PhoneNumber , Checked ,queShiAlarmSetting; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.qsyjpage);
	    ...
	    //访问服务器并返回一个流 
	    InputStream	input = PublicHttpActivity.getJSONData(App.GetQueShiAlarmSetting ,params);
	    qsbjList = ReadFile.getQsbjList(input);
	    
	    Checked = qsbjList.getChecked() ;
	    if (Checked.equals("1")) {
	    ...
	    PhoneNumber = qsbjList.getPhoneNumber();
		...
		addtel.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				//给弹出的Dialog确定按钮添加监听
				new AlertDialog.Builder(QsbjActivity.this).setTitle("添加电话号").setView(layout)
						...
						// TODO Auto-generated method stub
						 ...
						 if (teledittextString.isEmpty()) {
							 ...
							 Map<String, String> v = new HashMap<String, String>();
								...
								SimpleAdapter listadapter = new SimpleAdapter(QsbjActivity.this, listdata, R.layout.tel_list_item, 
						        		new String[]{"textviewname"},new int[]{R.id.mainlist_textveiw});
								listviewselect.setAdapter(listadapter);
							}
					}
		...
		listviewselect.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
				final int i = arg2 ;
				new AlertDialog.Builder(QsbjActivity.this)
		...
		setButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				getparams();
				InputStream	input1 = PublicHttpActivity.getJSONData(App.QueShiAlarmSetting ,params);
			    ...
			    if (sbstring.contains("设置成功")) {
			    	Toast.makeText(QsbjActivity.this, "设置成功！", Toast.LENGTH_SHORT).show();
				}else {
					Toast.makeText(QsbjActivity.this, "设置失败！", Toast.LENGTH_SHORT).show();
				}
	...
	protected void getparams() {
		...
		queShiAlarmSetting = "{" +"PhoneNumber"+":"+"'"+"'"+PhoneNumber+"'"+"'"+","+"Checked"+":"+"'"+"'"+Checked+"'"+"'"+"}";
		
		params.add(new BasicNameValuePair("stationId",stationId ));
		params.add(new BasicNameValuePair("queShiAlarmSetting",queShiAlarmSetting ));
	...
	private void findViewById() {
		...
		setButton = (Button) findViewById(R.id.setbutton_qsbj);
		cancleButton = (Button) findViewById(R.id.canclebutton_qsbj);

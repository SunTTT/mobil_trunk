...
public class SystemstateActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.system_ztpage);
		...
		//访问服务器并返回一个流 
	    InputStream	input = PublicHttpActivity.getJSONData(App.GetAlarmSystem ,params);
		...
		addtel.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				//给弹出的Dialog确定按钮添加监听
				new AlertDialog.Builder(SystemstateActivity.this).setTitle("添加电话号").setView(layout)
						...
						// TODO Auto-generated method stub
						 ...
						 //如果原先没有设置电话号码则telnum是空，设置的电话号码不为空，则将设置的号码直接赋值给telnum
							 ...
							 Map<String, String> v = new HashMap<String, String>();
								...
								SimpleAdapter listadapter = new SimpleAdapter(SystemstateActivity.this, listdata, R.layout.tel_list_item, 
						        		new String[]{"textviewname"},new int[]{R.id.mainlist_textveiw});
								listviewselect.setAdapter(listadapter);
		...
		listviewselect.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
				final int i = arg2 ;
				new AlertDialog.Builder(SystemstateActivity.this)
		...
		setButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				getparams();
				InputStream	input1 = PublicHttpActivity.getJSONData(App.SystemAlarm ,params);
			    ...
			    if (sbstring.contains("设置成功")) {
			    	Toast.makeText(SystemstateActivity.this, "设置成功！", Toast.LENGTH_SHORT).show();
				}else {
					Toast.makeText(SystemstateActivity.this, "设置失败！", Toast.LENGTH_SHORT).show();
				}
	...
	private void findViewById() {
		...
		setButton = (Button) findViewById(R.id.setbutton_system);
		cancleButton = (Button) findViewById(R.id.canclebutton_system);
